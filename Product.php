                    ...
                    <?php
                      ...
                      foreach($asr as $value){
                        ...
                        foreach($asr0 as $value){
                          echo '<a href="Apranq.php?id='.$value['id'].'" style="color: #EF4B37;"><li style="margin-left: 30px;">
                            '.$value['namearm'].'
                          </li></a>';
                        }
                        ...
                        foreach($asr1 as $value){
                          echo '<ul style="margin-left: 30px;">
                            ...
                            foreach($asr0 as $value){
                              echo '<a href="Apranq.php?id='.$value['id'].'" style="color: #EF4B37;"><li style="margin-left: 50px;">
                                '.$value['namearm'].'
                              </li></a>';
                            }
                            $asr1 = $mysql -> query("SELECT * FROM `subcategories` WHERE `incategory`=$is");
