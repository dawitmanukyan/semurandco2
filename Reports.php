          ...
          <div class="content-side">
            <ul class="nav-main">
              ...
              <li class="nav-main-item">
                ...
                <ul class="nav-main-submenu">
                  <li class="nav-main-item">
                  <?php echo '<a class="nav-main-link active" href="Reports.php?h='.$_GET['h'].'">' ?>
      ...
      <main id="main-container">
        ...
        <div class="bg-primary-dark">
          <div class="content content-full text-center pt-7 pb-6">
            <h1 class="h2 text-white mb-2">
              Կայքում առկա հաշվետվությունները
            </h1>
        ...
        <div class="content content-boxed">
          <div class="row">
            <!-- Story -->
            <?php
              $imgs = $mysql -> query("SELECT * FROM `reports`");

              foreach($imgs as $value){
                echo '<div class="col-lg-4"  style="text-align: center;">
                  <div class="block block-rounded block-link-pop overflow-hidden" href="assets/media/photos/'.$value['img'].'"> <br>
                    <h4>Տարեթիվ  - '.$value['date'].'</h4><br>
                    <a href = "reports/'.$value['file'].'" download><h4 style="margin: 5px;">Ներբեռնել Ֆայլը</h4></a><br>
                    <a href="delete-reports.php?h='.$_GET['h'].'&id='.$value['id'].'"><button class="btn btn-danger" style="margin:5px;">Ջնջել</button></a>
                  </div>
                </div>';
              }
            ?>
