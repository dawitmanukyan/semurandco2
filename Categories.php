...
<html lang="en">
  <head>
    ...
    <title>Կայքում Առկա Կատեգորիաներ</title>
          ...
          <div class="content-side">
            <ul class="nav-main">
              ...
              <li class="nav-main-item">
                ...
                <ul class="nav-main-submenu">
                  <li class="nav-main-item">
                  <?php echo '<a class="nav-main-link active" href="Categories.php?h='.$_GET['h'].'">' ?>
      ...
      <main id="main-container">
        ...
        <div class="content content-boxed">
          <div class="row">
            <!-- Story -->
            <?php
              $imgs = $mysql -> query("SELECT * FROM `assortment`");

              foreach($imgs as $value){
                echo '<div class="col-lg-4"  style="text-align: center;">
                  <div class="block block-rounded block-link-pop overflow-hidden" href="assets/media/photos/'.$value['img'].'">
                    <img class="img-fluid" src="img-categories/'.$value['img'].'" alt="">
                    <br><br><h4>Հայերեն - '.$value['type-arm'].'</h4>
                    <h4>Ռուսերեն - '.$value['type-ru'].'</h4>
                    <h4>Անգլերեն - '.$value['type-eng'].'</h4>

                    <a href="Delete.php?h='.$_GET['h'].'&id='.$value['id'].'&type=assortment&file=Categories.php"><button class="btn btn-danger" style="margin:5px;">Ջնջել</button></a>
                  </div>
                </div>';
              }
            ?>
