...
<html lang="en">
  <head>
    ...
    <title>Կայքում Առկա ենթակածեգորյաներ</title>
      ...
      <main id="main-container">
        ...
        <div class="bg-primary-dark">
          <div class="content content-full text-center pt-7 pb-6">
            <h1 class="h2 text-white mb-2">
              Կայքում առկա ենթակատեգորիաները
            </h1>
        ...
        <div class="content content-boxed">
          <div class="row">
            <!-- Story -->
            <?php
              $imgs = $mysql -> query("SELECT * FROM `subcategories`");

              foreach($imgs as $value){
                echo '<div class="col-lg-4"  style="text-align: center;">
                  <div class="block block-rounded block-link-pop overflow-hidden" href="img-subcategories/'.$value['img'].'">
                    <img class="img-fluid" src="img-subcategories/'.$value['img'].'" alt=""><br><br>
                    <h4>Հայերեն - '.$value['type-arm'].'</h4>
                    <h4>Ռուսերեն - '.$value['type-ru'].'</h4>
                    <h4>Անգլերեն - '.$value['type-eng'].'</h4>
                    <a href="delete-subcat.php?h='.$_GET['h'].'&id='.$value['id'].'"><button class="btn btn-danger" style="margin:5px;">Ջնջել</button></a>
                    </div>
